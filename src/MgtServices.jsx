...
return (
    ...
    <div>
        ...
        <p>
            ...
            We work with local realtors, real estte brokers, tenants and landlords to help property owners to 
        ...
        <p>
            ...
            <p>We collect the rent every month and direct deposit it to you on the 15th.
            We pay the Utility bills, taxes, and the mortgage and all the monthly accounting. </p>

            <h3>
                Inspections
            </h3>
            <p>We want to make sure yur property stays in top shape, so we conduct periodic inspections to ensure the tenants are mainaining your property as required.
            ...
            <p>We market your rental properties, coordinate and attend all of the showings, identify the best applicants, and draft and execute the lease for you.
            We screen all tenants for credit, criminal, and eviction history to try and get you the best tenants possible.</p>
            
            <h3>Reporting</h3>
            <p>We send you an itemized owner's statement each month detailing all the income and expenses associated with your property. 
                You also have 24/7 access to all your property information by logging in to the owner portal. </p>

            <h3>Maintenance</h3>
            <p>We manage all property maintenance and offer you unbeatable pricing and service.
                We have an extensive network of contractors that can tackle any repair. Whether it is fixing a leaky faucet or a complet renovation, we can coordinate it all.
                That means no tenants calling you at all hours of the day asking for maintenance.
            </p>
            <h3>Compliance</h3>
            We make sure you and your property stay up to dte with all licensing requirements and comply with all local, state and deferal laws. 
